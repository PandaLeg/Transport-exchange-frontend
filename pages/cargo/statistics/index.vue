...
<script>
    ...
    export default {
        ...
        computed: {
            getPointsInside() {
                return this.$store.getters['cargo/getPointsInside']
            },

            getPointsFrom() {
                return this.$store.getters['cargo/getPointsFrom']
            },

            getPointsTo() {
                return this.$store.getters['cargo/getPointsTo']
            },
        ...
        methods: {
            async getCountries() {
                ...
                await this.$store.dispatch('cargo/getCountPlaces', this.formData);
